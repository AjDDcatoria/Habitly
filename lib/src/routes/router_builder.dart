...
import 'package:habitly/src/features/main/presentation/pages/update_habit_page.dart';
...
class AppRouteBuilder {
  ...
  static Widget updateHabit(BuildContext context, GoRouterState state) {
    return const UpdateHabitPage();
  }
}
